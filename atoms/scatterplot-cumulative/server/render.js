import mainHTML from "./atoms/scatterplot-cumulative/server/templates/main.html!text"
/*import fs from 'fs'
...
//weekly_deaths_avg_per_million
    ...
    vaccinationsCountryNames.map(d => {
        ...
        if(matchCases && matchDeaths){
            ...
            country.forEach((date,i) => {
                ...
                if(+date.total_vaccinations_per_hundred > 0){
                    previousVaccinations = +date.total_vaccinations_per_hundred
                }
                ...
                allArr.push(
                {
                    ...
                    total_vaccinations_per_hundred:+date.total_vaccinations_per_hundred == 0 ? previousVaccinations : +date.total_vaccinations_per_hundred
                })
    ...
    fs.writeFileSync('assets/all-cumulative.json', JSON.stringify(allArr));
